...
[よくある質問](../../Faq.md) > Google Meet よくある質問
...
- [一般向けMeetとGoogle Workspace版Meetの違い](#一般向けmeetとgoogle-workspace版meetの違い)
- [主催者を変更したい](#主催者を変更したい)
- [毎回同じURL(ミーティングコード)を使いたい](#毎回同じurlミーティングコードを使いたい)
...
一般向けMeetには主に以下の制限があります。
- Googleアカウントを持たないユーザーは参加できません。(参加者はGoogleアカウントが必要です)
- ビデオストリーミング、録画機能が使えません。
- 1つの会議に参加できる人数は最大100人。会議時間は通常で最長60分ですが、2021年3月31日まで制限されません。(2020/9/30で終了予定のものが延長されました)

日本連盟から提供しているMeetアカウントはGoogle Workspace for Educationのもので、以下の特徴があります。
- 1つの会議に参加できる人数は最大100人で時間制限はありません
- 録画機能が使えます
- 外部の参加者も参加ができます
- ライブストリーミングは利用できません
- ブレイクアウトセッションは使えません

その他の制限、特徴は [Education エディションの比較](https://support.google.com/a/answer/10077155#meet) を参照して下さい。
